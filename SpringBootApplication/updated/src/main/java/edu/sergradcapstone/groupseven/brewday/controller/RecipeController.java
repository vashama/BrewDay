...
public class RecipeController {
    ...
    public ResponseEntity save(HttpSession httpSession, @RequestParam("IBU") Double ibu, @RequestParam("ABV") Double abv, @RequestParam("batchSize") Double batchSize, @RequestParam("Description") String description,
        ...
        if(optradio.contentEquals("PUBLIC")) {
            recipe = new Recipe(batchSize, abv, description, ibu, boilTime, brewType, "PUBLIC");
        }else{
            recipe = new Recipe(batchSize, abv, description, ibu, boilTime, brewType, username);
        }
